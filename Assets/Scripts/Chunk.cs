...
public class DeprecatedChunk : MonoBehaviour
{
    ...
    public void Initialize(ChunkData data)
    {
        ...
        GameObject tempMaterial = new GameObject(); // PrefabManager.instance.chunkMaterials[data.material];
        ...
        foreach (Transform child in children)
        {
            if (child.CompareTag("BombSlot") || data.material != 0)
                Instantiate(tempMaterial, child.position, Quaternion.identity, transform);
